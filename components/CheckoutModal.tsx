        ...
        <div className="bg-white rounded-2xl shadow-2xl max-w-md w-full max-h-[90vh] overflow-y-auto relative">
          ...
          <div className="p-6">
            ...
            <div className="text-center mb-6">
              <h2 className="text-2xl font-bold text-[#24234C] leading-tight">
                Join over 700,000 users to achieve your goals
              </h2>
            </div>
            ...
            <div className="flex items-center justify-center gap-2 mb-6">
              <svg width="20" height="20" viewBox="0 0 20 20" fill="none" xmlns="http://www.w3.org/2000/svg">
                <path d="M10 1L3 4V9C3 13.5 6.5 17.5 10 19C13.5 17.5 17 13.5 17 9V4L10 1Z" fill="#22C55E" stroke="#22C55E" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round"/>
                <path d="M7 10L9 12L13 8" stroke="white" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"/>
              </svg>
              <h3 className="text-lg font-semibold text-[#24234C]">Safe checkout</h3>
            </div>
