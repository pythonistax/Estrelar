    ...
    <div className="relative min-h-screen overflow-x-hidden bg-white">
      <div className="relative z-10 mx-auto flex h-full min-h-full w-full max-w-[400px] flex-col tablet:max-w-full pb-[104px] gap-6">
        ...
        <div className="h-12 tablet:h-16">
          <div className="relative flex h-full items-center justify-center border-b-2 border-secondary">
            {/* Back Button */}
            {onBack && (
              <button
                type="button"
        ...
        <div className="flex flex-1 flex-col items-center justify-center px-4 py-8 gap-8">
          ...
          <p className="text-xl font-semibold text-main text-center px-4">
            {sellingPage.challengeMessage}
          </p>

          {/* CTA Button */}
          <div className="fixed bottom-0 left-0 right-0 z-10 bg-white border-t border-gray-200 px-4 py-4 tablet:relative tablet:border-t-0 tablet:px-0 tablet:pt-8">
            <button
              onClick={onContinue}
              className="w-full max-w-xs mx-auto rounded-lg bg-accent-main p-4 text-base font-semibold uppercase text-white shadow-[0px_8px_24px_0px_rgba(86,83,254,0.3)] transition-all hover:opacity-90 tablet:max-w-md"
            >
              {sellingPage.cta}
            </button>
          </div>
